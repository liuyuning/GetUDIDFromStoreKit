...
In SKPaymentQueue’s delegate we can get "Receipt Data" from SKPaymentTransaction in state of SKPaymentTransactionStatePurchased.
...
The "Receipt Data" will send to Apple and verify the purchase is success.
Actually， the "Receipt Data" is a old-style property list, like below and in file "transactionReceipt".
...
The "purchase-info" contain many info encode by base64. After decode, like below and in file "purchase-info".
...
Then, the "unique-identifier" is the UDID, the same as Xcode, iTunes and "[UIDevice currentDevice] uniqueIdentifier]".
